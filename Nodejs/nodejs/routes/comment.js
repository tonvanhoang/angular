...
router.post('/add' ,async function(req,res,next){
    ...
    const {id_account,id_product,comment,rep_comment,datecomment} = req.body;
    const data = await modelscomment.create({_id,id_account,id_product,comment,rep_comment,datecomment})
